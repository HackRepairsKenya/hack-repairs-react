...
const PTable: React.FC<PTableProps> = ({ products, fetchProducts, outOffStock }) => {
            ...
            ? zeroQuantityItems.map((item:Product, index) => (
                <tr key={index} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                  ...
                  <td className="px-6 py-4">
                    ...
                    <button className="font-medium text-sky-600 dark:text-blue-500 hover:underline ml-2">
                      <LuEye />
                    </button>
                  </td>
                </tr>
  ...
  <UpdateProductModal handleCallClose={closeUpdateProducts} product={product} />
)}
