...
const FloatingButton = () => {
  return (
    <div className="fixed bottom-4 right-4 z-50">
      <button className=' w-[60px] h-[60px] rounded-full flex justify-center animate-pulse'>
        <span>
          <Link
            ...
            target='_blank'
          >
            <span className='flex gap-2 justify-center text-green-800 h-full mt-3  items-center'><span><IoLogoWhatsapp className='w-[40px] h-[40px]'/></span> 
            </span>
          </Link>
        </span>
      </button>
